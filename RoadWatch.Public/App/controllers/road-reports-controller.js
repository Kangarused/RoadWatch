...
(function (RoadWatch) {
    ...
    (function (Controllers) {
        var RoadReportsController = (function () {
            function RoadReportsController($scope, $state, reportDataService, markerTileService, signalrDataService) {
                var _this = this;
                this.$scope = $scope;
                this.$state = $state;
            ...
            RoadReportsController.prototype.setupSignalrConnection = function () {
                var _this = this;
            ...
            RoadReportsController.$inject = ['$scope', '$state', 'reportDataService', 'markerTileService', 'signalrDataService'];
