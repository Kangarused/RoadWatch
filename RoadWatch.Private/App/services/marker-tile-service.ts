module RoadWatch.Services {
    export interface IMarkerTileService {
        normalIconSize: Models.ISize;
        errorIconSize: Models.ISize;

        getAllMarkerTiles(): Models.IMapMarkerTile[];
    ...
    export class MarkerTileService implements IMarkerTileService {
        ...
        normalIconSize = <Models.ISize>{ width: 28, height: 49 };
        errorIconSize = <Models.ISize>{ width: 47, height: 81 };
